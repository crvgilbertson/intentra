...
```bash
go install github.com/crvgilbertson/intentra@v0.5.4
```

> **Note:** Pin to a specific version (e.g. `@v0.5.4`) rather than `@latest`. Version matters for infra tools.
...
Found 7 hunk(s) across the diff.
  ...
  │ base: e4a91bc3d1f2  •  engine v0.5.4
  └─────────────────────────────────────────────────────┘
